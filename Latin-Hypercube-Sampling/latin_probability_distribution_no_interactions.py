...
"""
points = np.array(lhs(10, samples=100))  # This will now be reproducible due to np.random.seed()
...
array_limits = []
sh_file = []
for t in range(2): # this telllls the programm to use the first 50 or 100 ecs filles, so that i can run several ecs parallel
    ecs = t*500
    print(t)
    for i in range(0, len(points)):
        ...
        sh_file.append(["python3 MAIN_no_interactions.py {} {} {} {} {} 0.2 1.0 1.0 0.2 0.3 0.5 0.15 1.0 0.2 0.15 1.0 0.4 {} {} {} {} {} {} {}".format(
